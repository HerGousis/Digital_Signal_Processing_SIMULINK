...
## kouz_laboratory_2
Οι εκφωνησεις των κουζς ειναι [[κουζ1.pdf]]( https://github.com/HerGousis/Digital_Signal_Processing_SIMULINK/blob/main/kouz_laboratory_2/help4quiz_0304.pdf) , [[κουζ2.pdf]]( https://github.com/HerGousis/Digital_Signal_Processing_SIMULINK/blob/main/kouz_laboratory_2/help4quiz_0403.pdf) ,

 <div style="text-align:center;">
    <img src="kouz_laboratory_2/1.png" alt="1" width="800">
</div>

και γραφουμε στο ```MATLAB```
```
quiz_0304(5865019,3.00,'C:\tmp_dsp_lab\lab2\')
```
για το κουζ2 
...
``` 
conv([5 8 6 5 0 1 9], [9 1 0 5 6 8 5])
```
και γραφουμε στο ```MATLAB```
```
